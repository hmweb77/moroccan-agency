  ...
  fr: {
    ...
    about: {
      ...
      stats: {
        ...
        coffee: "Litres de cafés consommés",
        laughs: "Fous rires"
      },
      mission: {
        title: "NOTRE MISSION",
        description: "Améliorer la communication de votre entreprise et générer des ventes pour accroître votre chiffre d'affaires et vous garantir un retour sur investissement de vos dépenses marketing et publicité. À l'écoute, nous nous adaptons à vos besoins, vos objectifs et votre organisation afin de vous proposer un accompagnement sur-mesure."
      },
      values: {
        title: "NOS VALEURS",
    ...
    contact: {
      hero: {
        ...
        description: "Prêt à transformer vos idées en réalité ? Notre équipe d'experts est là pour vous accompagner à chaque étape de votre projet.",
  ...
  ar: {
    ...
    about: {
      ...
      stats: {
        ...
        coffee: "لترات من القهوة المستهلكة",
        laughs: "ضحكات"
      },
      mission: {
        title: "مهمتنا",
        description: "تحسين اتصالات شركتك وتوليد المبيعات لزيادة إيراداتك وضمان عائد على استثمارك في الإنفاق التسويقي والإعلاني. نحن نستمع ونتكيف مع احتياجاتك وأهدافك وتنظيمك لنقدم لك مرافقة مخصصة."
      },
      values: {
        title: "قيمنا",
    ...
    contact: {
      hero: {
        title: "اتصل بنا",
        description: "هل أنت مستعد لتحويل أفكارك إلى واقع؟ فريق خبرائنا هنا لمرافقتك في كل خطوة من مشروعك.",
        cta1: "بدء مشروع",
        cta2: "جدولة مكالمة"
      },
      form: {
  ...
  en: {
    ...
    about: {
      ...
      stats: {
        ...
        coffee: "Liters of coffee consumed",
        laughs: "Laughs"
      },
      mission: {
        title: "OUR MISSION",
        description: "Improve your company's communication and generate sales to increase your revenue and guarantee a return on investment from your marketing and advertising expenses. Listening, we adapt to your needs, your objectives and your organization to offer you tailor-made support."
      },
      values: {
        title: "OUR VALUES",
    ...
    contact: {
      hero: {
        title: "CONTACT US",
        description: "Ready to turn your ideas into reality? Our team of experts is here to support you at every step of your project.",
